...
class Attention(nn.Module):
    def __init__(
        ...
        self.control = box_qp_control(
            eps_rel=eps_rel, eps_abs=eps_abs, verbose=verbose, reduce=reduce
        )
        self.QP = SolveBoxQP(control=self.control)
    ...
    def forward(self, Q, V):
        ...
        x_stacked = self.QP.forward(Q1_stacked, P_stacked, None, None, lb_stacked, ub_stacked)
