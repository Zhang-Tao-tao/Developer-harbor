...
$A_{pq}^{h} = \frac{|E(\theta,\varphi)|^{2}}{L^{2}}{sinc}^{2}\left( \frac{\pi h}{L} \right) \times e^{j\lbrack k_{x}(m_{p} - m_{q})d + k_{y}(n_{p} - n_{q})d - 2\pi h(l_{p} - l_{q})/L\rbrack}$ $\ (2)$
...
![](images/media/image1.png){width="7.4527777777777775in" height="3.1847222222222222in"}

### 六、CIM真机(KaiWU-CPQC-550)求解性能分析

> **注：由于CIM真机限制(数据比特不超过550bit)，仅进行M, N, L,n-bit=8\*8\*4\*2的情况求解(原论文为8\*8\*8\*2)**

#### ![](images/media/image2.png){width="3.625232939632546in" height="2.484527559055118in"}1.参数设置及程序执行结果

![](images/media/image3.png){width="3.5935990813648293in" height="2.488497375328084in"}

#### 2.真机求解最优相位配置

![](images/media/image4.png){width="6.823700787401575in" height="2.4427252843394576in"}
...
![](images/media/image5.png){width="7.452083333333333in" height="3.317361111111111in"}
...
![](images/media/image6.png){width="3.889122922134733in" height="2.9098501749781276in"}![](images/media/image7.png){width="2.8375in" height="2.915277777777778in"}

#### 4.性能分析

> 1.与论文原始算法的性能对比

![](images/media/image8.png){width="7.452083333333333in" height="1.8902777777777777in"}

> 2.时间性能对比

![](images/media/image9.png){width="7.454166666666667in" height="0.9604166666666667in"}
